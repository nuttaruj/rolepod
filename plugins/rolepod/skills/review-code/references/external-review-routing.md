...
**Strong class.** Dispatch the internal general pass on a strong-class model, even under a balanced Lead — never a balanced model. An external runs on its own CLI's default model.
