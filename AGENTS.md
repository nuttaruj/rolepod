...
This project is indexed by GitNexus as **rolepod** (1609 symbols, 1659 relationships, 8 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
