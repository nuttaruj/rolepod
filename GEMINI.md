...
- Before edit symbol → file tools or code-intel index
...
- High-risk (auth/billing/migrations) → `/rolepod-full` first, then external reviewer:
...
| Symbol / caller / impact | code-intel index if connected, else `rg` + Read |
...
<!-- Auto-generated by build/render.sh — lean view. Full 18-agent catalog: docs/agents.md. -->
