...
| All shell scripts | `bash -n` clean (install.sh, bootstrap.sh, render.sh, 12 core hook scripts, the codex adapter's subagent-model-log.sh, 5 gemini hook scripts, 3 cursor scripts) |
