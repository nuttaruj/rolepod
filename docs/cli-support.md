...
| Gemini CLI  | ✓ | ✓ | ✓ verified (SessionStart hook fires) | ✓ verified (15 skills enumerated) | **Production** |
...
Installs:
- `~/.gemini/extensions/rolepod/` (full extension: `GEMINI.md` context file, 15 agents in `agents/`, 15 skills, 5 hooks)
