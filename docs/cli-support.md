...
| All shell scripts | `bash -n` clean (install.sh, bootstrap.sh, render.sh, 14 core hook scripts, the codex adapter's subagent-model-log.sh + agent-sync.sh, 5 gemini hook scripts, 5 cursor scripts) |
