...
└── antigravity/
    ...
    └── hooks/hooks.json                 (PreInvocation / PreToolUse / PostToolUse / Stop — gemini hook scripts + agy-only stop-unlock)
```
