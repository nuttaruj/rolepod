...
generate_skill_index() {
...

  {
    ...
    echo "<!-- Core 10 only: Tier 0 router + Tier 1 workflow skills. Legacy skill names are documented in docs/legacy-skill-map.md, not shipped as executable shims. -->"
...
generate_skill_index_lean() {
  ...
  {
    echo "<!-- Auto-generated by build/render.sh — lean Core 10 view (Tier 0 + Tier 1 only). Full catalog: core/fragments/skill-index.md → docs/skills.md. -->"
