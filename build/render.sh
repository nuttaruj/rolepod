...
generate_skill_index() {
...

  {
    ...
    echo "<!-- Core 10 workflow skills (Tier 0 router + Tier 1) + 1 command alias (rolepod-full). Legacy skill names are documented in docs/legacy-skill-map.md, not shipped as executable shims. -->"
    ...
    # Command alias — explicit force-full entrypoint, not a phase/domain skill.
    # rolepod-full is the 11th skill dir; it is the /rolepod-full alias, not
    # part of the Core 10 workflow spine.
    emit_phase_section "Command Alias" \
      rolepod-full
...
generate_skill_index_lean() {
  ...
  {
    echo "<!-- Auto-generated by build/render.sh — lean view: Tier 0 router + Tier 1 workflow + command alias. Full catalog: core/fragments/skill-index.md → docs/skills.md. -->"
