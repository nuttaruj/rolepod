...
# Entry docs embed this instead of a full 16-row table. The shipped agent
...
generate_agent_roster_lean() {
  ...
  {
    echo "<!-- Auto-generated by build/render.sh — lean view. The 16 agent files that ship ARE the full catalog. -->"
    echo ""
