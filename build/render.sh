...
generate_agent_roster_lean() {
  local out="$REPO_DIR/core/fragments/agent-roster-lean.md"
  {
    ...
    echo ""
    echo "**16 specialists** organized by domain (backend / frontend / mobile / billing / ai-ml / data / qa / security / performance / architecture / product / business / design / ops / content / universal-review). Lead doesn't pick from a list — \`write-plan\` maps path + concern + risk → agent when delegation helps. Full catalog: [docs/agents.md](docs/agents.md)."
  } > "$out"
}
