...
generate_skill_index() {
...

  {
    ...
    echo "<!-- Grouped by the 6-phase lifecycle taxonomy: Define / Plan / Build / Verify / Review / Ship / Cross-cutting. -->"

    emit_phase_section "Define" \
      spec-driven-development

    emit_phase_section "Plan" \
      planning-and-task-breakdown \
      parallel-contract-orchestration \
      api-and-interface-design

    emit_phase_section "Build" \
      anti-spaghetti \
      claude-api \
    ...
    emit_phase_section "Cross-cutting" \
      context-engineering \
