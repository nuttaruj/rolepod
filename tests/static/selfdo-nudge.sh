...
#
# R2 arms it too (R2 now routes to a task owner on main, not Lead self-do):
# it fires on the Lead's FIRST product-code edit after an R2 route, with its
# own message naming the owner-on-main path; R3/R4 keep the 6-edit floor and
# the dispatch-to-Owner wording. Never on R1.
#
