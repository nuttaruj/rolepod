...
check "hook scripts per manifest = Claude 16 / Codex 10 / Gemini 5 / Cursor 3 / Antigravity 4 (actual: $HC_CLAUDE/$HC_CODEX/$HC_GEMINI/$HC_CURSOR/$HC_AGY)" \
  "[ $HC_CLAUDE -eq 16 ] && [ $HC_CODEX -eq 10 ] && [ $HC_GEMINI -eq 5 ] && [ $HC_CURSOR -eq 3 ] && [ $HC_AGY -eq 4 ]"
