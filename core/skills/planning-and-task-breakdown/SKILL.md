...
| Excuse | Reality |
|--------|---------|
| "I have it in my head, I don't need to write tasks down" | 'In my head' = invisible to collaborators + lost at /clear. Written tasks survive context resets and let parallel agents pick work safely. |
